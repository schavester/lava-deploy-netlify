...
2-200;var p="status=no,height=300,width=550,resizable=yes,left="+d+",top="+m+",screenX=#{left},screenY=#{top},toolbar=no,menubar=no,scrollbars=no,location=no,directories=no";"facebook"===a?b="https://www.facebook.com/sharer.php?u="+b:"twitter"===a?b="https://twitter.com/share?url="+b+"&text="+c:"linkedin"===a?b="https://www.linkedin.com/shareArticle?mini=true&url="+b:"pinterest"===a?b="//pinterest.com/pin/create/button/?url="+b+"&description="+c:"email"===a&&e.tbLocalScript!==g&&(c=""!==c?c+"%0D%0A":
